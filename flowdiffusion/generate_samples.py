...
class Sample_Generator():
    def __init__(self):
        ...
        self.model_path = "/mnt/data0/xiaoxiong/single_view_goal_diffusion/results/libero_spatial/RFlow_libero_spatial_100k_90%/ckpt/model_100000.pt"
        self.hdf5_file="/mnt/data0/xiaoxiong/FID/libero_spatial/RF_libero_spatial_RGB_100k_90%_timestep_3.hdf5"
    ...
    def setup_models(self):
        ...
        self.rectified_flow = RectifiedFlow(sample_timestep=self.sample_step)
    ...
    def sample(self, x_cond, x_gt, task_embed):
        ...
        noise = torch.randn_like(x_gt, device=self.device)
        noise = rearrange(noise, "b f c h w -> b (f c) h w")
        x_pred = self.rectified_flow.sample(self.unet, noise, x_cond, task_embed)
