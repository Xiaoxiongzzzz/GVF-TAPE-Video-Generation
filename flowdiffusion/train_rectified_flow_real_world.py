...
from real_world_dataset import RealWorldDataset
...
class RectifiedFlowTrainer:
    def __init__(self, args):
        ...
        self.batch_size = 8
        self.data_path = "/home/ZhangChuye/Data/corl_tele_tasks"
        ...
        # Save paths    
        self.results_base_dir = "/mnt/data0/xiaoxiong/single_view_goal_diffusion/real_world_results"
        self.model_name = "RFlow_real_world_tele_tasks_scratch_rgb_100k_128"
    ...
    def setup_data(self):
        self.train_set = RealWorldDataset(
